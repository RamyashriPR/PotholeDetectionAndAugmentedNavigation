...
import static hackathon.honeywell.potholedetectionandlogging.MapsActivity.initlocation;
//import static hackathon.honeywell.potholedetectionandlogging.MapsActivity.locationslist;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
   ...
   public static DBHandler dbHandler;
    ...
    public void printDB(View view){
        Intent i = new Intent(MainActivity.this,PotholeList.class);
        startActivity(i);
    ...
    public void setThreshold(View view){
        try{
            ...
            Toast.makeText(getApplicationContext(),"THRESHHOLD CHANGED",Toast.LENGTH_LONG).show();
        }
        catch (Exception e){
        }
    }
